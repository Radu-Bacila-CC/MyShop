...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            httpContext.Request.Cookies.Add(new System.Web.HttpCookie("eCommerceBasket") { Value = basket.Id }); controller.ControllerContext = new System.Web.Mvc.ControllerContext(httpContext, new System.Web.Routing.RouteData(), controller);
            controller.ControllerContext = new System.Web.Mvc.ControllerContext(httpContext, new System.Web.Routing.RouteData(), controller);
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            {
                Id = "1",
                Email = "brett.hargreaves@gmail.com",
                ZipCode = "90210"
            });
